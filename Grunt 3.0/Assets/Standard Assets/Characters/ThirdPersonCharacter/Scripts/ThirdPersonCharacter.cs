...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		[SerializeField] public float m_GroundCheckDistance = 0.25f;
		...
		public float M_ForwardAmount { // not part of original code
			get {
		...
		void CheckGroundStatus()
		{
			...
			Debug.DrawRay(startPosition, ray, Color.cyan);
#endif
			// 0.1f is a small offset to start the ray from inside the character
			// it is also good to note that the transform position in the sample assets is at the base of the character
			if (Physics.Raycast(startPosition, ray, out hitInfo, m_GroundCheckDistance))
			{
